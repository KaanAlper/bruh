            ...
            while True:
                ...
                for(x, y, w, h) in faces:
                    ...
                    if conf < 100:
                        ...
                        #Isim = df.loc[df['Id'] == OgrenciNumara]['Name'].values
                    ...
                    if (100-conf) > 67:
                        ...
                        Isim = str(Isim)[2:-2]
                        attendance.loc[len(attendance)] = [OgrenciNumara, Isim, Saat]
                        sqldate=datetime.datetime.fromtimestamp(ts).strftime('%d_%m_%Y')
                        cursor.execute("CREATE TABLE IF NOT EXISTS yoklama_bilgileri_"+sqldate+"(OgrenciNumara int(255),Isim varchar(255),Saat varchar(255));")
                        print("Table Olusturuldu....")
                        sql = "INSERT INTO yoklamasistemi.yoklama_bilgileri_"+sqldate+"(OgrenciNumara,Isim,Saat) VALUES (%s,%s,%s);"
